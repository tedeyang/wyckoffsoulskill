...
├─────────────┼─────────────┼────────────────────────────────────────┤
│ ¥[价格]     │ [X]%        │ 高: ¥[高价] / 低: ¥[低价] / 中: ¥[中] │
│ [涨跌幅]%   │ [低位/中/高]│ 支撑: ¥[支撑] / 压力: ¥[压力]         │
└─────────────┴─────────────┴────────────────────────────────────────┘

趋势: **[上涨/下跌/震荡]** │ 阶段: **[Phase A/B/C/D]** │ 信号: **[Spring/Upthrust/无]**
...
│ 事件                 │ 概率     │ 解读                             │
├──────────────────────┼──────────┼──────────────────────────────────┤
│ Spring (5天)         │ [X]%     │ [高/中/低]概率出现反弹           │
│ 向上突破 (10天)      │ [X]%     │ [高/中/低]概率突破区间           │
│ Distribution (5天)   │ [X]%     │ [高/中/低]概率进入派发           │
│ 趋势延续             │ [X]%     │ 当前趋势继续的可能性             │
└──────────────────────┴──────────┴──────────────────────────────────┘
...
📋 数据质量
────────────────────────────────────────────────────────────────────
日线: [N]根 ([日期范围]) │ 周线: [N]根 ([日期范围]) │ 耗时: [X]ms
```
